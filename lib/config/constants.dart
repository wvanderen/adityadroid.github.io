class Constants {
  ...
  static const PROFILE_FACEBOOK = 'https://www.facebook.com/DAVESWORKOFFICIAL';
  static const PROFILE_GITHUB = 'https://github.com/adityadroid/';
  static const PROFILE_TWITTER = 'https://twitter.com/adityadroid';
  static const PROFILE_INSTAGRAM = 'https://www.instagram.com/daves.work/';
  static const PROFILE_YOUTUBE =
      'https://www.youtube.com/channel/UCc_xeaqjFWlev3TtUUOjJgw';
}
